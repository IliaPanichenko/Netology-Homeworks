...
Если пользователь отвечает "да", то программа удаляет первый элемент из массива и выводит пользователю на экран обновлённый массив. Если массив опустел (больше удалять нечего), то программа сообщает об этом и завершает свою работу.
Если пользователь отвечает "нет", то программа благодарит пользователя, выводит на экран окончательное состояние массива и завершает свою работу.
Программа повторяет пункт 5 до тех пор, пока пользователь не ответит "нет", или пока массив не опустеет.
